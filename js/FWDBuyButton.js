...
(function (window){
	...
	var FWDBuyButton = function(
		...
		this.init = function(){
			...
			if(FWDRLS3DUtils.isIEAndLessThen9 || self.isMobile_bl){
		...
		this.buyClickHandler = function(){
			location.href = "https://codecanyon.net/item/simple-3d-coverflow/18707737?ref=FWDesign";
		}
		...
		this.scrollHandler = function(){
			var scrOfssets = FWDRLS3DUtils.getScrollOffsets();
			if(scrOfssets.y < 120){
				self.showHello();
			}
		}
		...
		this.buyAnimBackCompleteHandler = function(){
			if(FWDRLS3DUtils.isIEAndLessThen9 || self.isMobile_bl) return;
			self.showHello();
		};
    ...
    FWDBuyButton.setPrototype = function(){
    	FWDBuyButton.prototype = new FWDRLS3DDisplayObject("div");
    };
