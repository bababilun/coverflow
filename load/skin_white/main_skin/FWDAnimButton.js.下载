...
(function (window){
	...
	var FWDAnimButton = function(
		...
		this.init = function(){
			...
			self.image_do = new FWDRLS3DDisplayObject("img");
		...
		this.show = function(){
			self.setX(-self.w - 5);
			FWDS3DCovModTweenMax.to(self, .8, {x:0, ease:Expo.easeInOut});
		}
    ...
    FWDAnimButton.setPrototype = function(){
    	FWDAnimButton.prototype = new FWDRLS3DDisplayObject("div");
    };
