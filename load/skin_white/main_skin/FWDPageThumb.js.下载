/* FWDS3DCovPageThumb */
(function (window){
var FWDS3DCovPageThumb = function(id, bWidth, bHeight, nImgUrl, sImgUrl)
{
		var self = this;
		var prototype = FWDS3DCovPageThumb.prototype;
		...
		this.onClick = function(e){
			self.dispatchEvent(FWDS3DCovPageThumb.CLICK, {id:self.id});
		};
		...
		this.disable = function()
		{
			...
			FWDS3DCovModTweenMax.to(self, .1, {alpha:.2, ease:Expo.easeOut});
		};
		...
		this.destroy = function(){
			...
			self = null;
			prototype = null;
			FWDS3DCovPageThumb.prototype = null;
		};
	...
	/* set prototype */
	FWDS3DCovPageThumb.setPrototype = function(){
		FWDS3DCovPageThumb.prototype = new FWDRLS3DDisplayObject("div");
	};
	
	FWDS3DCovPageThumb.CLICK = "onClick";
	
	FWDS3DCovPageThumb.prototype = null;
	window.FWDS3DCovPageThumb = FWDS3DCovPageThumb;
}(window));