/* FWDS3DCovPageMenu */
(function (window){
var FWDS3DCovPageMenu = function(props_obj){
		
		var self = this;
		var prototype = FWDS3DCovPageMenu.prototype;
		...
		this.setupButtons = function()
		{
			...
			for(var i=0; i<self.totalButtons; i++){
				...
				button = new FWDS3DCovPageMenuButton(self.menuLabels_ar[i*2], self.menuLabels_ar[i*2 + 1], disableButton_bl);
				button.id = i;
				button.addListener(FWDS3DCovPageMenuButton.CLICK, self.buttonClickHandler);
		...
		this.buttonClickHandler = function(e){
			self.dispatchEvent(FWDS3DCovPageMenuButton.CLICK, {id:e.target.id});
		};
	...
	/* set prototype */
	FWDS3DCovPageMenu.setPrototype = function(){
		FWDS3DCovPageMenu.prototype = new FWDRLS3DDisplayObject("div");
	};
	
	FWDS3DCovPageMenu.CLICK = "onClick";

	FWDS3DCovPageMenu.prototype = null;
	window.FWDS3DCovPageMenu = FWDS3DCovPageMenu;
}(window));